...
- 설정 가이드
  ...
  ├─────────────────────────────────────────────────────────────────────────────┤
  │                                                                             │
  │   countWorkingDays(A, B) = N                                                │
  │                    ↓                                                        │
  │   addWorkingDays(A, N) ≠ B   ← 🔴 역관계 성립 안 함!                           │
  │                                                                             │
  │   ══════════════════════════════════════════════════════════════════════════│
  │                                                                             │
  │   예시:                                                                      │
  │   ┌─────────────────────────────────────────────────────────────────────┐  │
  │   │ countWorkingDays(월, 화) = 1                                        │  │
  │   │ addWorkingDays(월, 1)    = 월   ← 같은 날!                         │  │
  │   │                                                                      │  │
  │   │ 기대: addWorkingDays(월, 1) = 화                                   │  │
  │   └─────────────────────────────────────────────────────────────────────┘  │
  │                                                                             │
  │   ══════════════════════════════════════════════════════════════════════════│
  │                                                                             │
  ...
  │                                                                             │
  │   1. 드래그 시작:                                                          │
  │      offset = countWorkingDays(기준Task, 이Task) = 1                      │
  │                                                                             │
  │   2. 드래그 완료/미리보기:                                                  │
  │      newDate = addWorkingDays(기준새위치, offset=1)                       │
  │             = 기준새위치 그대로 (1일 앞으로 가지 않음)                      │
  │                                                                             │
  │   3. 결과:                                                                 │
  │      기준 Task와 offset=1인 Task가 같은 위치에 렌더링됨!                   │
  │                                                                             │
  └─────────────────────────────────────────────────────────────────────────────┘